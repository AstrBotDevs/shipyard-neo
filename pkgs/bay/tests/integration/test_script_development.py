"""E2E-09: Script Development and Debugging (IDE-style workflow) tests.
...
class TestE2E09ScriptDevelopment:
    """E2E-09: Script Development and Debugging (IDE-style workflow)."""
...
"""
                ...
                assert "23" in result["output"], \
                    f"Expected '23' in output, got: {result['output']}"
